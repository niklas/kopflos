...
Yo dog, I heard you like testing, so I put some virtual framebuffer onto your
system so you can test while you have no actual display.
...
* disable kopflos temporary -- to look at your browser from time to time
